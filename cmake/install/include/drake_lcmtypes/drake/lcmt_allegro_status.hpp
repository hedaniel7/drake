...
#ifndef __drake_lcmt_allegro_status_hpp__
#define __drake_lcmt_allegro_status_hpp__
...
int lcmt_allegro_status::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcmt_allegro_status::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int lcmt_allegro_status::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t lcmt_allegro_status::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* lcmt_allegro_status::getTypeName()
{
    return "lcmt_allegro_status";
}

int lcmt_allegro_status::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int lcmt_allegro_status::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int lcmt_allegro_status::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t lcmt_allegro_status::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x8d235a54b2c7b3d1LL;
