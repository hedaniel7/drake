...
class BeamModelParams final : public drake::systems::BasicVector<T> {
 public:
  ...
  [[nodiscard]] BeamModelParams<T> with_lambda_short(const T& lambda_short) const {
  ...
  [[nodiscard]] BeamModelParams<T> with_probability_short(const T& probability_short) const {
    BeamModelParams<T> result(*this);
  ...
  [[nodiscard]] BeamModelParams<T> with_probability_miss(const T& probability_miss) const {
    BeamModelParams<T> result(*this);
  ...
  [[nodiscard]] BeamModelParams<T> with_probability_uniform(const T& probability_uniform) const {
    BeamModelParams<T> result(*this);
  ...
  void Serialize(Archive* a) {
    ...
    a->Visit(drake::MakeNameValue("probability_uniform", &probability_uniform_ref));
  }
