...
struct SchunkWsgTrajectoryGeneratorStateVectorIndices {
  ...
  /// In other words, `SchunkWsgTrajectoryGeneratorStateVectorIndices::GetCoordinateNames()[i]`
...
template <typename T>
class SchunkWsgTrajectoryGeneratorStateVector final : public drake::systems::BasicVector<T> {
 public:
  ...
  SchunkWsgTrajectoryGeneratorStateVector() : drake::systems::BasicVector<T>(K::kNumCoordinates) {
  ...
  SchunkWsgTrajectoryGeneratorStateVector& operator=(const SchunkWsgTrajectoryGeneratorStateVector& other) {
    this->values() = other.values();
    return *this;
  }
  SchunkWsgTrajectoryGeneratorStateVector& operator=(SchunkWsgTrajectoryGeneratorStateVector&& other) noexcept {
  ...
  SetToNamedVariables() {
    ...
    this->set_trajectory_start_time(symbolic::Variable("trajectory_start_time"));
    this->set_last_position(symbolic::Variable("last_position"));
    this->set_max_force(symbolic::Variable("max_force"));
  }

  [[nodiscard]] SchunkWsgTrajectoryGeneratorStateVector<T>* DoClone() const final {
  ...
  [[nodiscard]] SchunkWsgTrajectoryGeneratorStateVector<T> with_last_target_position(const T& last_target_position) const {
  ...
  [[nodiscard]] SchunkWsgTrajectoryGeneratorStateVector<T> with_trajectory_start_time(const T& trajectory_start_time) const {
    SchunkWsgTrajectoryGeneratorStateVector<T> result(*this);
  ...
  [[nodiscard]] SchunkWsgTrajectoryGeneratorStateVector<T> with_last_position(const T& last_position) const {
    SchunkWsgTrajectoryGeneratorStateVector<T> result(*this);
  ...
  [[nodiscard]] SchunkWsgTrajectoryGeneratorStateVector<T> with_max_force(const T& max_force) const {
    SchunkWsgTrajectoryGeneratorStateVector<T> result(*this);
  ...
  void Serialize(Archive* a) {
    ...
    a->Visit(drake::MakeNameValue("last_target_position", &last_target_position_ref));
    T& trajectory_start_time_ref = this->GetAtIndex(K::kTrajectoryStartTime);
    a->Visit(drake::MakeNameValue("trajectory_start_time", &trajectory_start_time_ref));
  ...
  void ThrowIfEmpty() const {
    if (this->values().size() == 0) {
      throw std::out_of_range(
          "The SchunkWsgTrajectoryGeneratorStateVector vector has been moved-from; "
