...
struct CompassGaitContinuousStateIndices {
  ...
  /// In other words, `CompassGaitContinuousStateIndices::GetCoordinateNames()[i]`
...
class CompassGaitContinuousState final : public drake::systems::BasicVector<T> {
 public:
  ...
  CompassGaitContinuousState() : drake::systems::BasicVector<T>(K::kNumCoordinates) {
    this->set_stance(0.0);
    this->set_swing(0.0);
  ...
  CompassGaitContinuousState& operator=(const CompassGaitContinuousState& other) {
    this->values() = other.values();
    return *this;
  }
  CompassGaitContinuousState& operator=(CompassGaitContinuousState&& other) noexcept {
  ...
  [[nodiscard]] CompassGaitContinuousState<T> with_stance(const T& stance) const {
  ...
  [[nodiscard]] CompassGaitContinuousState<T> with_stancedot(const T& stancedot) const {
    CompassGaitContinuousState<T> result(*this);
  ...
  [[nodiscard]] CompassGaitContinuousState<T> with_swingdot(const T& swingdot) const {
    CompassGaitContinuousState<T> result(*this);
