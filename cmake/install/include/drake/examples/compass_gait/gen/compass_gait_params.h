...
class CompassGaitParams final : public drake::systems::BasicVector<T> {
 public:
  ...
  [[nodiscard]] CompassGaitParams<T> with_length_leg(const T& length_leg) const {
    CompassGaitParams<T> result(*this);
  ...
  [[nodiscard]] CompassGaitParams<T> with_center_of_mass_leg(const T& center_of_mass_leg) const {
    CompassGaitParams<T> result(*this);
  ...
  void Serialize(Archive* a) {
    ...
    a->Visit(drake::MakeNameValue("center_of_mass_leg", &center_of_mass_leg_ref));
