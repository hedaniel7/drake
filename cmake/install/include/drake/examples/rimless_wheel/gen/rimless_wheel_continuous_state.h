...
struct RimlessWheelContinuousStateIndices {
  ...
  /// In other words, `RimlessWheelContinuousStateIndices::GetCoordinateNames()[i]`
...
template <typename T>
class RimlessWheelContinuousState final : public drake::systems::BasicVector<T> {
 public:
  ...
  RimlessWheelContinuousState() : drake::systems::BasicVector<T>(K::kNumCoordinates) {
    this->set_theta(0.0);
  ...
  RimlessWheelContinuousState& operator=(const RimlessWheelContinuousState& other) {
    this->values() = other.values();
    return *this;
  }
  RimlessWheelContinuousState& operator=(RimlessWheelContinuousState&& other) noexcept {
  ...
  [[nodiscard]] RimlessWheelContinuousState<T> with_theta(const T& theta) const {
  ...
  [[nodiscard]] RimlessWheelContinuousState<T> with_thetadot(const T& thetadot) const {
    RimlessWheelContinuousState<T> result(*this);
