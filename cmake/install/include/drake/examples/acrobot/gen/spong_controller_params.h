...
class SpongControllerParams final : public drake::systems::BasicVector<T> {
 public:
  ...
  [[nodiscard]] SpongControllerParams<T> with_balancing_threshold(const T& balancing_threshold) const {
    SpongControllerParams<T> result(*this);
  ...
  void Serialize(Archive* a) {
    ...
    a->Visit(drake::MakeNameValue("balancing_threshold", &balancing_threshold_ref));
  }
