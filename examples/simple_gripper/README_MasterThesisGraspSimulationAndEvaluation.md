...
![alt text](figures/AIMM.png)

![alt text](figures/PipelineNew.jpeg)
...
- [DrakeDynamic.cc](DrakeDynamic.cc) (dynamic grasp simulation with force/torque application)
...
![alt text](figures/Average_MinMaxScores_AllObjects.png)
